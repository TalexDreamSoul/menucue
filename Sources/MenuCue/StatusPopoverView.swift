...
enum SettingsPane: String, CaseIterable, Identifiable {
  ...
  var subtitle: String {
    switch self {
    case .overview:
      return "This Mac at a glance, sampling behaviour, and anything needing attention."
    case .dateAndEvents:
      return "Calendar display, overview time zone, and week layout."
    case .quickActions:
      return "Run any action, pin your favorites, and manage Apple Shortcuts."
    case .menuBarTimeZones:
  ...
  private var updateStatusMessage: String {
    ...
    case .idle:
      return updateService.automaticUpdatesEnabled
        ? "\(ProductBrand.displayName) checks for updates every 12 hours."
    ...
    case .current:
      return "\(ProductBrand.displayName) is up to date."
